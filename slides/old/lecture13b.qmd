...
2. Effect size
3. Sample size 
4. Alpha (type 1 error tolerance)
...
There are many ways to calculate effect size, and the methods vary across the different types of analyses
...
![](images/gpower-logo.png)
G*Power, a piece of software dedicated to power analysis
...
2. Determine anticipated effect size (calculation needed here!)
